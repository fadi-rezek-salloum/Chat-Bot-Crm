...
const Notification = () => {
  ...
  const {authTokens ,setNotificationCount , notificationCount } = useContext(AuthContext)



  const { notifications , setOffset } = useStateContext()
...
const handleScroll = (e) => {
  ...
  return (
    <div className=' h-full pb-4 ' >
       ...
       <div className="h-full px-6   overflow-y"> {/* Set a fixed height and enable vertical scrolling */}
